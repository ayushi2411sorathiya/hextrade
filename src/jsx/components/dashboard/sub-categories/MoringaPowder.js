...
import saragavanoImage from '../../../../images/sargavano_powder.jpeg';
      ...
      <section className="product-info-section mb-4">
        <div className="row align-items-center">
          <div className="col-md-6 mb-4 mb-md-0" data-aos="zoom-in-up" data-aos-easing="linear"
            ...
            <img src={saragavanoImage} alt="Sargavano Powder" className="img-fluid onion-img" />
          </div>
          <div className="col-md-6" data-aos="fade-right">
            <div className="sub-heading about-heading">
              <h2 className='fs-3'>Product Information</h2>
            </div>
            <p> <b>Indian Name: </b> Saragvano Powder</p>
            <p>Moringa Powder is the powder extracted by drying and
              milling the leaves of Moringa oleifera.
              It is highly rich in nutrients.
              Used in beverages, soups, sauce, baked
              food, salads, smoothies & snacks.
            </p>
